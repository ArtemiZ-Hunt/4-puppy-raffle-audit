...
// @audit-info use of floating pragma is a bad practice
...
contract PuppyRaffle is ERC721, Ownable {
    ...
    // @audit - it should not return 0 as if there is no such player always the player indexed 0 will be checked
